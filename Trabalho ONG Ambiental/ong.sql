...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/06/2025 às 23:52
...
INSERT INTO `novidades` (`id`, `titulo`, `conteudo`, `dia`, `data_publicacao`) VALUES
(1, 'Lançamento', 'Lançamento Blusa Mundo Verde', '2025-06-19 11:05:56', '2025-06-19 15:01:06'),
(2, 'Lançamento', 'Lançamento Copo Mundo Verde', '2025-06-19 11:05:56', '2025-06-19 15:01:06');
...
(3, 'Blusa Ecológica Mundo Verde', '', 'https://i.imgur.com/uSdVSxm.jpeg', 99.99),
(4, 'Copo Ecológico Mundo Verde', '', 'https://i.imgur.com/9aWZZc9.jpeg', 20.00);
...
(1, 'Sabrina', 'a@a.com', '$2y$10$AQOV85BD1bLOcC1zByaHoeBxCaEHQ2VNov6DH8NmEqeEWZUMJLv/S', '2025-06-17 22:46:54'),
(2, 'gabriel', 'gabriel@gmail.com', '$2y$10$ZIJ63SHJElOeqn7Bc2ziluxOFrN0I0PmQjCUhE1vyxJfTnIhXmY4C', '2025-06-13 16:45:44');
...
--
ALTER TABLE `carrinho`
  ADD CONSTRAINT `carrinho_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios_site` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `itens_carrinho`
  ...
  ADD CONSTRAINT `itens_carrinho_ibfk_1` FOREIGN KEY (`carrinho_id`) REFERENCES `carrinho` (`id`) ON DELETE CASCADE,
